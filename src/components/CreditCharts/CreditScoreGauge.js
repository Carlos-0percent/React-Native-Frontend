...
import { CreditScoreLevel, IsAndroid, IsTablet } from "../../constants/Constants";
    ...
    return (
        <View style={styles.container}>
            <VictoryPie
                ...
                height={IsTablet ? 480 : 320}
                innerRadius={IsTablet ? 170 : 120}
                startAngle={90}
                endAngle={-90}
                style={chartView}
            />
...
const styles = StyleSheet.create({
    ...
    scoreTextWrapper: {
        ...
        alignItems: "center",
        alignSelf: "center",
        top: IsTablet ? 118 : IsAndroid ? 72 : 76
    },
    scoreText: {
        fontSize: IsTablet ? 56.1 : 38,
        fontFamily: Fonts.MontserratBold
    },
    creditText: {
        fontSize: IsTablet ? 20.7 : 14,
        fontFamily: Fonts.MontserratRegular
    },
    scoreType: (color) => ({
        fontSize: IsTablet ? 26.6 : 18,
