...
export const SubscriptionPlans = [
    { duration: "1 month", name: "Gold Plan", type: "gold" },
    { duration: "1 year", name: "Platinum Plan", type: "platinum" },
]

export const AccountsFilters = [
    { label: "All Accounts", value: "all" },
    { label: "Open Accounts", value: "open" },
    { label: "Closed Accounts", value: "closed" },
    { label: "Inactive Accounts", value: "inactive" },
    { label: "Negative Accounts", value: "negative" },
]
...
export const IsTablet = ScreenWidth > 700
